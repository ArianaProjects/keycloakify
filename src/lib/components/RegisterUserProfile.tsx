...
const UserProfileFormFields = memo(({ kcContext, ...props }: { kcContext: KcContextBase.Register; } & KcProps) => {
	...
	return (
		kcContext.profile.attributes.map(
			attribute => {
						...
						const node = (
							<div className={cx(props.kcFormGroupClass)}>
								{(() => {
									...
									const groupDisplayHeader = attribute.groupDisplayHeader ?? "";

									let groupHeaderText: string;

									if( groupDisplayHeader !== "" ) {
										groupHeaderText = advancedMsg(attribute.groupDisplayHeader)!groupName
